...
* Starting this unit, you will begin to use Node.js. Be sure to have it installed on your computer **before** attending your classes. You can follow the installation instructions for [Mac](./Important/nodejs-install-mac.md) and [Windows](./Important/nodejs-install-win.md) computers.  
